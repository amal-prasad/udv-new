...
export function EscapeSection() {
  return (
    <section className="relative h-[85dvh] w-full overflow-hidden bg-[#1E3140]">
      <motion.div
        initial={{ opacity: 0, y: 16 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.6 }}
        transition={{ duration: 0.7, ease: "easeOut" }}
        className="relative z-10 mx-auto flex h-full max-w-2xl flex-col items-center justify-center gap-4 px-4 text-center"
      >
        <h2 className="font-display text-4xl font-semibold tracking-tight text-[#EDEDE7] md:text-6xl">
          Tired of the same four walls?
        </h2>
        <p className="max-w-md text-lg text-[#AEB8BE]">
