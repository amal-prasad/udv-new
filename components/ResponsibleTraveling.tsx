        ...
        <div className="flex flex-col gap-6 md:col-span-7">
          ...
          >
            {[
              ...
              "To us responsible travel is all about travelling in a conscious and intentional way. Whistle stop tours aren’t what were about. Instead, we like to build deep connections to a place and it’s people. We recognise that as travellers we are always guests in another’s home and so we always work to build a relationship with local communities so that we can bring to them the sort of tourism that enables their flourishing.",
